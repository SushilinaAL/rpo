 ...
 *      Test suite data     : C:/Users/User/Desktop/rpo/libs/mbedtls/mbedtls/tests/suites/test_suite_md.data
 *
 */
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = ".\\test_suite_md.datax";
